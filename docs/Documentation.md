...
Fortune Pro is a multi-asset portfolio management platform designed for relationship managers to manage multiple client portfolios. The system supports equity (NSE), mutual funds, and commodity exposure, with an opinionated focus on risk analytics and explainable visualisations rather than full retail trading.

**Key Features:**
- Multi-client portfolio management (single manager, many clients)
- Support for NSE, MF, and COMMODITY asset categories
- Live-simulated portfolio tracking with synthetic price movements
- Trade capture (buy/sell) and realised P&L history
- Risk analytics (beta, VaR-style daily loss estimate, concentration signals)
- Dashboard visualisations driven by Chart.js
- Embedded AI chatbot for portfolio and chart explanations
...
│  │  - RAGService (file-based knowledge retrieval)            │   │
│  │  - VisualisationExplanationService                        │   │
│  └──────────────────────────────────────────────────────────┘   │
│                              │                                   │
│  ┌──────────────────────────────────────────────────────────┐   │
│  │              Repository Layer                             │   │
...
│  - CORS configuration                                           │
│  - DataSeeder for initial assets and demo clients               │
│  - File-based RAG knowledge base                                │
└─────────────────────────────────────────────────────────────────┘
```
